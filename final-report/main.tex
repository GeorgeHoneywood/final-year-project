...
Accessibility is a particularly relevant concern for my project. % TODO: expand on why!
...
\begin{figure}[ht]
    ...
    \caption{Simulating deuteranopia, in Firefox Dev Tools}\label{fig:deuteranopia}
\end{figure}
