...
PWAs are the concept that web applications should be able to present themselves as, and have similar features to native applications (FIXME: CITE THIS). For example PWA like abilities could include offline support, ability to ``install'' the website on mobile platforms, and features like push notifications. In order to make web app installable, you have to write a web manifest. The manifest provides metadata about your application, allowing you to control how it will be displayed in the user's app list. In my manifest I provide icons to use, long and short names to use, and a description.
