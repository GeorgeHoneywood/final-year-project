...
Hence, OpenSteetMap uses the variously named ``Web Mercartor'' projection (FIXME: list some others). This projection is conformal, meaning that (locally) angles on the map are the same as angles on the ground, even if lengths are not preserved.
