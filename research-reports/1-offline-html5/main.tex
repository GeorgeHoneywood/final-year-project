...
It seems like the File and Directory Entries API~\cite{w3c-file-directories-api} will likely be most appropriate, as it has the ability to act like a local file system. This would allow my app to have a flow like:
